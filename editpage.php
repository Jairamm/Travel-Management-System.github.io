...
<body>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body second ">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link" href="flight.php"><img
                  src="https://img.icons8.com/?size=100&id=8771&format=png&color=000000" alt="..." height="30px ">
                Flight</a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu first  ">
                ...
                <li><a class="dropdown-item"
                    href="https://www.lonelyplanet.com/articles/best-places-to-visit-in-india"><img
    ...
    <div class="row g-5">
      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        <div class="card" style="width: 18rem;">
          <img src="https://th.bing.com/th/id/OIP.dOnPPG2QVHadeR55NQBf8gHaE6?rs=1&pid=ImgDetMain" class="card-img-top"
            alt="...">
          <div class="card-body">
          ...
          <div class="card-body">
            ...
            <a href="profile.php" class="card-link">Go To Profile</a>
          </div>
        </div>
        <!-- some add here   -->
      </div>
        ...
        <form class="needs-validation" novalidate="" action="#" method="post" enctype="multipart/form-data">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" title="Enter the name" class="form-control" name="Name" id="Name"
                placeholder="Your Name" value="<?php echo $res['name']; ?>" required readonly />
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" title="your Gender" name="Gender" id="Gender" placeholder=""
                value="<?php echo $res['gender']; ?>" required="" required />
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" name="Username" title="Enter unique Username" id="Username"
                  placeholder="Username" required="" required value="<?php echo $res['username']; ?>" />
                <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input title="Enter the Email" type="email" class="form-control" name="Email" id="Email"
                placeholder="you@example.com" required value="<?php echo $res['email']; ?>" />
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" title="Your Address" class="form-control" name="Address" id="Address"
                placeholder="Tedhi Bazaar Balrampur near Avadha Palace" required="" required value="" />
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              <label for="Phone" class="form-label">Phone
                <span class="text-body-secondary"></span></label>
              <input type="number" title="Phone or Whatapp number" class="form-control" name="Phone" id="Phone"
                placeholder="eg. 8840206985" value="<?php echo $res['phone']; ?>" />
            </div>
            ...
            <div class="col-md-4">
              ...
              <select class="form-select" name="State" id="State" placeholder="U.P" required=""
            ...
            <div class="col-md-3">
              ...
              <input type="text" title="Profession" class="form-control" name="Profession" id="Profession"
                placeholder="eg.Teacher" required value="<?php echo $res['profession']; ?>" />
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE `profile` SET `username`='$username',`name`='$name',`email`='$email',`phone`='$phone',`profession`='$profession',`gender`='$gender',`country`='$country',`state`='$state' WHERE id ='$ids' ";
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $insert)) {
      ...
      $_SESSION["no"] = $phone;
      echo "FIle Upload Successfully".$_SESSION["no"];
    } else {
